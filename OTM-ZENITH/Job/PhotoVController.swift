...
protocol PhotoViewerController: DTPhotoViewerControllerDelegate {
    func simplePhotoViewerController(_ viewController: PhotoVController, savePhotoAt index: Int)
}
...
class PhotoVController: DTPhotoViewerController {
